...
(Reference: Table creation shown in pages 1–2 of the file  ￼)

⸻

🧱 1. Database Schema Design (Normalization Included)
...
(Shown across SQL blocks on pages 1–3  ￼)

⸻

📝 2. Data Insertion (Realistic Institutional Dataset)
...
(Examples shown on pages 2–4 of the second file  ￼)

⸻

🛠️ 3. Data Manipulation & SQL Queries
...
The SQL results visualize institutional behavior:
	•	Computer Science has the highest student count (page 3 output).
	•	Instructors like Dr. Anjali Menon teach multiple courses.
	•	Course enrollments range from 1–3 per subject (page 6 chart).
￼
...
This project demonstrates my ability to:
	...
	•	Analyze data for academic decision-making
